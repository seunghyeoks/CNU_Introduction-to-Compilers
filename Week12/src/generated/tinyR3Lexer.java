...
public class tinyR3Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "FUNC", "U32", "RETURN", "LET", "MUT", "OR", 
			"AND", "LE", "GE", "EQ", "NE", "ID", "LITERAL", "LIT_INT", "LIT_STR", 
	...
	public tinyR3Lexer(CharStream input) {
		super(input);
